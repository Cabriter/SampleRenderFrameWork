...
GLuint CreateTexture2D(unsigned char* pixelData,int width,int heiglt,GLenum type){
    GLuint texture;
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, type, width, heiglt, 0, type, GL_UNSIGNED_BYTE, pixelData);
